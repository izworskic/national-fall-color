...
test("Blue Ridge page is a distinct indexable corridor decision surface", () => {
  ...
  assert.match(html, /<title>Blue Ridge Parkway Fall Colors 2026: Best Color Now/);
  ...
  assert.match(html, /Best modeled corridor now/);
  ...
  assert.match(html, /nps\.gov\/blri\/planyourvisit\/roadclosures\.htm/);
